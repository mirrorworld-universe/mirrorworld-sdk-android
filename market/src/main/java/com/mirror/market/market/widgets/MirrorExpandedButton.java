...
//
//        mArrowImageUp.setVisibility(VISIBLE);
//        mArrowImageDown.setVisibility(GONE);
//
...
//    @Override
//    public void expand(){
//        ObjectAnimator.ofFloat(mArrowImageUp, ROTATION.getName(), 180).start();
//        mIsExpanded = true;
...
//    @Override
//    public void fold(){
//        ObjectAnimator.ofFloat(mArrowImageUp, ROTATION.getName(), -180, 0).start();
//        mIsExpanded = false;
