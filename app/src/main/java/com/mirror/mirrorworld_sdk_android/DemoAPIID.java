...
public class DemoAPIID {
    ...
    public static final int GET_COLLECTION_INFO = 1003;
    public static final int GET_NFT_EVENTS = 1004;
    public static final int SEARCH_NFTS = 1005;
    public static final int RECOMMEND_SEARCH_NFT = 1006;
    public static final int GET_NFTS = 1007;
    public static final int GET_NFT_REAL_PRICE = 1008;
